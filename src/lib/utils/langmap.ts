...
const languageData: LanguageMap = {
	...
	'af-NA': { nativeName: 'Afrikaans (Namibia)', englishName: 'Afrikaans (Namibia)' },
	'af-ZA': { nativeName: 'Afrikaans (South Africa)', englishName: 'Afrikaans (South Africa)' },
	...
	'ar-SA': { nativeName: 'العربية (السعودية)', englishName: 'Arabic (Saudi Arabia)' },
	...
	'bn-BD': { nativeName: 'বাংলা(বাংলাদেশ)', englishName: 'Bengali (Bangladesh)' },
	...
	'de-AT': { nativeName: 'Deutsch (Österreich)', englishName: 'German (Austria)' },
	'de-DE': { nativeName: 'Deutsch (Deutschland)', englishName: 'German (Germany)' },
	'de-CH': { nativeName: 'Deutsch (Schweiz)', englishName: 'German (Switzerland)' },
	...
	'en-AU': { nativeName: 'English (Australia)', englishName: 'English (Australia)' },
	'en-CA': { nativeName: 'English (Canada)', englishName: 'English (Canada)' },
	'en-IE': { nativeName: 'English (Ireland)', englishName: 'English (Ireland)' },
	'en-IN': { nativeName: 'English (India)', englishName: 'English (India)' },
	'en-PI': { nativeName: 'English (Pirate)', englishName: 'English (Pirate)' },
	'en-UD': { nativeName: 'English (Upside Down)', englishName: 'English (Upside Down)' },
	'en-US': { nativeName: 'English (US)', englishName: 'English (US)' },
	'en-ZA': { nativeName: 'English (South Africa)', englishName: 'English (South Africa)' },
	'en@pirate': { nativeName: 'English (Pirate)', englishName: 'English (Pirate)' },
	...
	'es-AR': { nativeName: 'Español (Argentine)', englishName: 'Spanish (Argentina)' },
	'es-419': { nativeName: 'Español (Latinoamérica)', englishName: 'Spanish (Latin America)' },
	'es-CL': { nativeName: 'Español (Chile)', englishName: 'Spanish (Chile)' },
	'es-CO': { nativeName: 'Español (Colombia)', englishName: 'Spanish (Colombia)' },
	'es-EC': { nativeName: 'Español (Ecuador)', englishName: 'Spanish (Ecuador)' },
	'es-ES': { nativeName: 'Español (España)', englishName: 'Spanish (Spain)' },
	'es-LA': { nativeName: 'Español (Latinoamérica)', englishName: 'Spanish (Latin America)' },
	'es-NI': { nativeName: 'Español (Nicaragua)', englishName: 'Spanish (Nicaragua)' },
	'es-MX': { nativeName: 'Español (México)', englishName: 'Spanish (Mexico)' },
	'es-US': { nativeName: 'Español (Estados Unidos)', englishName: 'Spanish (United States)' },
	'es-VE': { nativeName: 'Español (Venezuela)', englishName: 'Spanish (Venezuela)' },
	et: { nativeName: 'eesti keel', englishName: 'Estonian' },
	'et-EE': { nativeName: 'Eesti (Estonia)', englishName: 'Estonian (Estonia)' },
	...
	'fr-CA': { nativeName: 'Français (Canada)', englishName: 'French (Canada)' },
	'fr-FR': { nativeName: 'Français (France)', englishName: 'French (France)' },
	'fr-BE': { nativeName: 'Français (Belgique)', englishName: 'French (Belgium)' },
	'fr-CH': { nativeName: 'Français (Suisse)', englishName: 'French (Switzerland)' },
	...
	hy: { nativeName: 'Հdelays', englishName: 'Armenian' },
	'hy-AM': { nativeName: 'Հdelays', englishName: 'Armenian' },
	...
	'is-IS': { nativeName: 'Íslenska (Iceland)', englishName: 'Icelandic (Iceland)' },
	...
	mai: { nativeName: 'মৈথিলী', englishName: 'Maithili' },
	...
	'mk-MK': { nativeName: 'Македонски (Македонски)', englishName: 'Macedonian (Macedonian)' },
	...
	'nb-NO': { nativeName: 'Norsk (bokmål)', englishName: 'Norwegian (bokmal)' },
	...
	'nl-BE': { nativeName: 'Nederlands (België)', englishName: 'Dutch (Belgium)' },
	'nl-NL': { nativeName: 'Nederlands (Nederland)', englishName: 'Dutch (Netherlands)' },
	nn: { nativeName: 'Nynorsk', englishName: 'Nynorsk' },
	'nn-NO': { nativeName: 'Norsk (nynorsk)', englishName: 'Norwegian (nynorsk)' },
	...
	'pa-IN': { nativeName: 'ਪੰਜਾਬੀ (ਭਾਰਤ ਨੂੰ)', englishName: 'Punjabi (India)' },
	...
	'pt-PT': { nativeName: 'Português (Portugal)', englishName: 'Portuguese (Portugal)' },
	...
	'sk-SK': { nativeName: 'Slovenčina (Slovakia)', englishName: 'Slovak (Slovakia)' },
	...
	'th-TH': { nativeName: 'ภาษาไทย (ประเทศไทย)', englishName: 'Thai (Thailand)' },
	...
	'zh-CN': { nativeName: '中文（中国）', englishName: 'Chinese Simplified (China)' },
	'zh-HK': { nativeName: '中文（香港）', englishName: 'Chinese Traditional (Hong Kong)' },
	'zh-SG': { nativeName: '中文（新加坡）', englishName: 'Chinese Simplified (Singapore)' },
	'zh-TW': { nativeName: '中文（台灣）', englishName: 'Chinese Traditional (Taiwan)' },
...
export const langmap: LanguageMap = new Proxy(languageData, {
	get(target, prop: string): LanguageInfo | undefined {
		const normalizedLang = normalizeLang(prop);
		return target[normalizedLang];
	}
});
